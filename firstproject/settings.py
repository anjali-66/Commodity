...
in this Django instance .
apps can be used in multiple  project ,and you can package and distribute them
...
SECRET_KEY = 'django-insecure-qxo-3mgjr!ml=+sa=d$6lh1ylx*kk8@=1rr@y4t2q#z%^ctlj_'
